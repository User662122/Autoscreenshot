...
class WebRTCManager(
    ...
    private val server = WebSocketSignalingServer(8080)
    ...
    private fun startCapture() {
        ...
        peerConnection!!.addTrack(factory.createVideoTrack("screen", videoSource))
    }
    ...
    private fun handleIce(msg: String) {
        ...
        peerConnection!!.addIceCandidate(
            IceCandidate(j.getString("sdpMid"), j.getInt("sdpMLineIndex"), j.getString("candidate"))
        )
    }
